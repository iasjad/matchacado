...
const About = () => {
  return (
    <div className="container mx-auto px-8 md:px-4 py-8">
      <h1 className="text-3xl font-semibold mb-4">About MatchaCado</h1>
      <p className="text-lg mb-6">
        MatchaCado is a crowdfunding platform designed for creators to fund
        ...
        you a matcha and avocado. Unlock the potential of your fanbase and bring
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
        ...
        <div className="flex items-center mb-6">
          <img
            className="w-20 h-20 rounded-full mr-4"
            src="/coin.gif"
            alt="Support Through MatchaCado"
          />
          <div>
            <h3 className="text-xl font-semibold mb-2">
              Support Through MatchaCado
            </h3>
            <p>
              Receive support from your fans in the form of matcha or avocado
